...
const ResetPasswordModal: FC<ResetPasswordModalProps> = ({
  ...
  const onResetPassword = async (values: {
    ...
    try {
      ...
      const response = await userStore.UpdateUserPassword(requestDto);
      if (response.passed) {
        SuccessNotification("Password has been updated successful");
      } else
        ErrorNotification("Password has not been updated!", response.message);
